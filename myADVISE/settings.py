"""
Django settings for myADVISE project on Heroku. Fore more info, see:
...
SECRET_KEY = "(i*!j@rkryus2wpn-z*y5=8=*jn+-om=fg@*sz!bwl*d*f(2zt"
...
WSGI_APPLICATION = 'myADVISE.wsgi.application'
